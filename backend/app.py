...
with app.app_context():
    ...
    if os.environ.get('SEED_DATA', 'true').lower() == 'true':
        if StagingIsotank.query.count() == 0 and Isotank.query.count() == 0 and Pedido.query.count() == 0:
            ...
            db.session.add(Isotank(id="ISO-9999", fornecedor="Fornecedor Gama", numeroContainer="GAMA5555555", localAtual="Matão/SP", produto1Canonico="Cold Pressed Orange Oil", statusTecnicoFinal="Processado", escopoAprovacao="Cold Pressed Orange Oil; Qualquer produto", statusDisponibilidade="Disponivel", aprovadoPara="CPOO"))
            db.session.add(Isotank(id="ISO-8888", fornecedor="Fornecedor Delta", numeroContainer="DELT8888888", localAtual="Ghent/BE", produto1Canonico="D-Limonene", statusTecnicoFinal="Processado", escopoAprovacao="D-Limonene; Óleos cítricos", statusDisponibilidade="Disponivel", aprovadoPara="Tudo"))
...
def create_isotank():
    ...
    new_iso = Isotank(
        ...
        aprovadoPara=data.get('aprovadoPara'),
